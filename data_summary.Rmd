...
dat.01 <- cbind(dat.01$ID, dat.01.1[order(names(dat.01.1))])
...
Try running a simple CJS. I totally forget how these things work... why would phi for non-sampling years come out to be 1.0 and capture probability non zero? 
