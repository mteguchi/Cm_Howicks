...
modelName <- paste(D00$Rdir, "Howicks2014/Model_Mtb.txt", sep = "")
...
bugs.data <- list(yaug = yaug, I = nrow(yaug), J = ncol(yaug))

inits <- function() list(z = rep(1, nrow(yaug)))

params <- c("N", "Omega", "deviance", "p", "c")
