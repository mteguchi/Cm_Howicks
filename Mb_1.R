...
modelName <- paste(D00$Rdir, "Howicks2014/Model_Mb.txt", sep = "")
Ddata <- paste(D00$Dtomo, "turtles/Australia/Howicks2014/", sep = "")
# first get data:
file01 <- paste(Ddata, 'HW14KAPT_26AUG2014A_01_AGECL_J.csv', sep = "")
